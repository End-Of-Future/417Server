function c10105400.initial_effect(c)
	...
	e4:SetDescription(aux.Stringid(10105400,0))
	e4:SetCategory(CATEGORY_DRAW)
	e4:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e4:SetProperty(EFFECT_FLAG_DELAY)
	e4:SetCountLimit(1,101054000)
...
function c10105400.spfilter(c,e,tp)
	return c:IsSetCard(0x1f1) and c:IsType(TYPE_MONSTER) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
