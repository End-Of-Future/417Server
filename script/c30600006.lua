...
function cm.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCodeFunRep(c,30600001,aux.FilterBoolFunction(Card.IsRace,RACE_DINOSAUR+RACE_SEASERPENT),1,63,true,true)
	...
	e2:SetDescription(aux.Stringid(30600006,1))
	e2:SetCategory(CATEGORY_RECOVER)
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e2:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
	e2:SetCode(EVENT_LEAVE_FIELD)
	e2:SetCountLimit(1,30600006)
	...
	e4:SetDescription(aux.Stringid(30600006,0))
