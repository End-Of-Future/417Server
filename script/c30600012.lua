...
function cm.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCodeFunRep(c,30600001,aux.FilterBoolFunction(Card.IsRace,RACE_BEAST+RACE_BEASTWARRIOR),1,63,true,true)
...
function cm.rectg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local de1=e:GetHandler():GetAttack()
	local de2=e:GetHandler():GetDefense()
