...
function cm.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCodeFunRep(c,30600001,aux.FilterBoolFunction(Card.IsRace,RACE_ROCK+RACE_WINDBEAST),1,63,true,true)
...
function cm.atkval(e,c)
	return Duel.GetMatchingGroupCount(nil,0,LOCATION_GRAVE,LOCATION_GRAVE,nil)*200
end
