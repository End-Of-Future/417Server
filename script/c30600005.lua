...
function cm.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCodeFunRep(c,30600001,aux.FilterBoolFunction(Card.IsRace,RACE_INSECT+RACE_PLANT),1,63,true,true)
...
function cm.valcheck(e,c)
	...
	if g:IsExists(Card.IsCode,1,nil,30600001) then
