...
"""
s2 = """
95780010 机械维度 爱染明王 0
88880103 恐啡肽狂龙·钉状龙 1
10105623 青眼白龙，哈哈哈 1
30683105 M·A·L·Enfocer 0
30683020 M·A·L·Breakthrough 1
30683110 M·A·L·Hydra 0
30678490 自律部队·地面部队 1
30683025 M·A·L·Metal Squad 1
914206452 真龙斗士 十二宫·处女 2
914206451 真龙斗士 十二宫·天秤 1
66300004 烈火战神·红缨 1
30679180 自律部队·补给中枢 1
91460010 太守 2
66300001 烈火战神·烈焰 2
91460006 男女 2
91460011 刘子骥 2
30683011 M·A·L·Gladiator 2
30683305 M·A·L·Growth Wedge 0
88885503 龙剑士 星辰·灵摆 1
95780026 机械维度 快鲨艇 0
95780014 机械维度 海妖 2
60002113 奇幻士兵 2
60001200 调酒师 卢娜 1
...
10105638 破坏之剑士-狂斩 2
27822034 激流之源石 0
10105644 传说中的白石（迫真） 1
91460002 忽逢桃花林 2
91480002 aoffghvlrbdddfqp3.Dispose() 3
88880101 默契交锋 0
27819018 圣光封印 0
66300000 烈火战神 藏身处 1
60002115 奇幻战略 2
...
for cd in l2:
    ...
    tag = True
    for ac in l1:
        if code == ac.split(' ')[0] and cnt != ac.split(' ')[-1]:
            ul.append(' '.join(cd.split(' ')[0:-1]) + "{0}->".format(ac.split(' ')[1]) + cnt)
            tag = False
    cnt = int(cnt)
    if tag:
        if cnt == 0:
