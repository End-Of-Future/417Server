...
function c88881656.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c88881656.desfil,tp,0,LOCATION_MZONE,1,nil) end 
...
function c88881656.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.GetMatchingGroup(c88881656.desfil,tp,0,LOCATION_MZONE,nil)  
