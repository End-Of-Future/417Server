...
--set
	...
	e7:SetCountLimit(1,66050021)
	e7:SetCost(c66060021.hxjcost)
...
function c66060021.hxjcost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c66060021.hxjlimit(e,c)
