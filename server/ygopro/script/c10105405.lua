function c10105405.initial_effect(c)
	...
	e3:SetDescription(aux.Stringid(10105405,1))
	...
	e5:SetDescription(aux.Stringid(10105405,2))
...
function c10105405.spfilter(c,tp)
	return c:IsSetCard(0x1f1) and Duel.GetMZoneCount(tp,c)>0
end
function c10105405.spcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetTurnPlayer()==1-tp
end
function c10105405.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroupEx(tp,c10105405.spfilter,1,nil,tp) end
	local g=Duel.SelectReleaseGroupEx(tp,c10105405.spfilter,1,1,nil,tp)
