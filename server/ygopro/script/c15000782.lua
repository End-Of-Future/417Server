...
function cm.initial_effect(c)
	--SynchroSummon
	c:EnableReviveLimit()
	aux.AddSynchroProcedure(c,aux.FilterBoolFunction(Card.IsSetCard,0xxxxx),aux.NonTuner(nil),1)
	...
	e0:SetCondition(cm.SynMixCondition(aux.Tuner(Card.IsCode,xxxxxxxx),nil,nil,aux.NonTuner(nil),1,99,gc))
	e0:SetTarget(cm.SynMixTarget(aux.Tuner(Card.IsCode,xxxxxxxx),nil,nil,aux.NonTuner(nil),1,99,gc))
	e0:SetOperation(cm.SynMixOperation(aux.Tuner(Card.IsCode,xxxxxxxx),nil,nil,aux.NonTuner(nil),1,99,gc))
