...
function cm.spcon(e,tp,eg,ep,ev,re,r,rp)  
	...
	return e:GetHandler():IsReason(REASON_COST) and re:GetHandler():IsSetCard(0xf39) and Duel.IsExistingMatchingCard(cm.spfilter,tp,0,LOCATION_ONFIELD,1,nil,e,tp)
end  
