...
local e4=Effect.CreateEffect(c)
	...
	e4:SetCountLimit(1,66060012)
	e4:SetCode(EVENT_PHASE+PHASE_END)
	e4:SetCost(c66060013.hxjcost)
...
local e5=Effect.CreateEffect(c)
	...
	e5:SetCountLimit(1,66050007)
	e5:SetCost(c66060013.hxjcost)
...
function c66060013.hxjcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	e1:SetTarget(c66060013.hxjlimit)
	e1:SetReset(RESET_PHASE+PHASE_END)
	Duel.RegisterEffect(e1,tp) end
end
function c66060013.hxjlimit(e,c)
