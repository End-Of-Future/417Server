...
--add to hand
	...
	e3:SetCountLimit(1,66050029)
	e3:SetCost(c66060002.hxjcost)
...
--spsummon
   local e7=Effect.CreateEffect(c)
	e7:SetDescription(aux.Stringid(66060002,2))
	e7:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e7:SetType(EFFECT_TYPE_IGNITION)
	e7:SetRange(LOCATION_GRAVE)
	e7:SetCountLimit(1,66060002)
...
function c66060002.hxjcost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c66060002.hxjlimit(e,c)
