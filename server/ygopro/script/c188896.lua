...
function cm.tg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if b1 then
		...
		e:SetCategory(CATEGORY_SPECIAL_SUMMON+CATEGORY_TODECK+CATEGORY_SEARCH+CATEGORY_TOHAND)
...
function cm.op1(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.GetMatchingGroup(function(c)return c:IsSetCard(0xca6) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand() and not c:IsCode(m)end,tp,LOCATION_DECK,0,nil)
