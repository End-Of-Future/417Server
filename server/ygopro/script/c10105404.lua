function c10105404.initial_effect(c)
	...
	e4:SetDescription(aux.Stringid(10105404,0))
	e4:SetCategory(CATEGORY_TOGRAVE)
	e4:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e4:SetCode(EVENT_SPSUMMON_SUCCESS)
	e4:SetProperty(EFFECT_FLAG_DELAY)
	e4:SetCountLimit(1,101054040)
...
function c10105404.filter(c,e,tp)
	return c:IsSetCard(0x1f1) and c:IsType(TYPE_MONSTER) and not c:IsCode(10105404) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function c10105404.tgfilter(c)
	return c:IsSetCard(0x1f1) and c:IsType(TYPE_MONSTER) and not c:IsCode(10105404) and c:IsAbleToGrave()
end
